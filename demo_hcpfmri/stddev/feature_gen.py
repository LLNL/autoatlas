...
train_folder = '/p/gpfs1/mohan3/Data/TBI/HCP/fMRI_var_flat_images/proc_768x384/train_zn'
test_folder = '/p/gpfs1/mohan3/Data/TBI/HCP/fMRI_var_flat_images/proc_768x384/test_zn'
...
train_subj = read_scolcsv(os.path.join(train_folder,'subjects.csv'))
test_subj = read_scolcsv(os.path.join(test_folder,'subjects.csv'))
...
def write_2colcsv(folder,subj):
    ...
    for s in subj:
        ...
        with open(os.path.join(folder,'{}_feature.csv'.format(s)),'w') as csv_file:
        ...
        with open(os.path.join(folder,'{}_target.csv'.format(s)),'w') as csv_file:
            writer = csv.writer(csv_file)
            writer.writerows(rows)
    ...
    with open(os.path.join(folder,'subjects_rlearn.csv'),'w') as csv_file:
        writer = csv.writer(csv_file)
