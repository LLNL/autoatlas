...
train_num = 80
in_folder = '/p/gpfs1/mohan3/Data/TBI/HCP/fMRI_var_flat_images/768x384'
out_folder = '/p/gpfs1/mohan3/Data/TBI/HCP/fMRI_var_flat_images/proc_768x384'

in_files = np.array(glob.glob(os.path.join(in_folder, '*_rfMRI_REST1_LR_var.png')))
