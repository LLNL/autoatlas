...
train_folder = '/p/lustre1/mohan3/Data/TBI/HCP/2mm/train_hcp_znrt'
test_folder = '/p/lustre1/mohan3/Data/TBI/HCP/2mm/test_hcp_znrt'
dims = [96,96,96]
...
def save_orgdata(in_files,out_folder):
    ...
    for in_filen in in_files:
        ...
        tt,_,_,_ = adjust_dims((vol-1).astype(int),z_min,z_max,y_min,y_max,x_min,x_max)
        tt[tt<0] = 0
        assert np.any(tt<=3)
