...
tags = ['znvol_HCP2TBI_smooth0_2_devr1_0_znrt']
save_dirs = ['znvol_HCP2TBI_smooth0_2_devr1_0_znrt']
test_dirs = ['test_tbi_znrt']
#subjs = ['148_2','44_2','13_2']
...
for tidx,tag in enumerate(tags):
    for sub in subjs:
        ...
        log_dir = '/p/gpfs1/mohan3/Data/TBI/HCP/2mm/{}/{}/{}/'.format(tag,test_dirs[tidx],sub)
        ...
        log_dir = '/p/gpfs1/mohan3/Data/TBI/HCP/2mm/{}/{}/{}/'.format('',test_dirs[tidx],sub)
