...
for i in range(test_start,test_start+num_test):
    ...
    #save_fig(rec[sh[0]//2],'rec{}_aenc{}_z.png'.format(i,achan),cmap='gray')
    #save_fig(rec[:,sh[1]//2],'rec{}_aenc{}_y.png'.format(i,achan),cmap='gray')
    #save_fig(rec[:,:,sh[2]//2],'rec{}_aenc{}_x.png'.format(i,achan),cmap='gray')
