...
#SBATCH -p pbatch
#SBATCH -A ccp
#SBATCH -o /g/g90/mohan3/Devs/TBI/autoatlas/logs/log_encode_2_1.txt

source ~/.bashrc
conda activate pytorch36
python encode.py --log_dir /p/lustre1/mohan3/Data/TBI/2mm/segin_norm2_linbott_aenc2_11_labels16_smooth0.1_devr1.0_freqs0.05 --load_epoch 399
